...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(navigatorKey: navigatorKey, initialLocation: '/login', routes: <RouteBase>[
    ...
    GoRoute(path: '/adminjobs', builder: (context, state) => const DummyPage(title: 'Admin Jobs')),
    GoRoute(path: '/contentModration', builder: (context, state) => const ReportsPage()),
    ...
    GoRoute(path: "/settings", builder: (context, state) => SettingsPage(), routes: [
      GoRoute(path: '/privacy', builder: (context, state) => const PrivacySettings()),
    ]),
  ]);
});
