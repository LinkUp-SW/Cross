...
import 'package:link_up/features/notifications/widgets/post_test_widget.dart';
import 'package:link_up/features/notifications/widgets/profile_test_widget.dart';
...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(navigatorKey: navigatorKey, initialLocation: '/login', routes: <RouteBase>[
    GoRoute(path: "/profile", builder: (context, state) => ProfilePage()),
    GoRoute(path: "/login", builder: (context, state) => const LoginPage(), routes: [
      GoRoute(path: "/forgotpassword", builder: (context, state) => const ForgotPasswordView()),
    ]),
    GoRoute(path: '/statistics', builder: (context, state) => const StatisticsView()),
    GoRoute(path: '/priv', builder: (context, state) => const DummyPage(title: 'Users')),
    GoRoute(path: "/signup", builder: (context, state) => const EmailPasswordView(), routes: [
      GoRoute(path: "/usersname", builder: (context, state) => const NamingPage()),
      GoRoute(path: "/getphone", builder: (context, state) => const GetPhoneNumber()),
      GoRoute(path: "/verification", builder: (context, state) => const Verification()),
      GoRoute(path: "/pastjobs", builder: (context, state) => const PastJobDetails()),
      GoRoute(path: "/takephoto", builder: (context, state) => const TakePhoto()),
  ...
  builder: (context, state) {
    ...
    return PostPagetest(postId: postId);
  },
    ),
    GoRoute(
      path: '/testprofile',
      builder: (context, state) {
        ...
        return ProfilePagetest(userId: userId);
      },
    ),
    ...
    StatefulShellRoute.indexedStack(
      ...
      branches: <StatefulShellBranch>[
        ...
        StatefulShellBranch(
          routes: <GoRoute>[
            GoRoute(path: "/postPage", builder: (context, state) => const PostPage(), routes: [
              GoRoute(
                path: '/focused',
        ...
        StatefulShellBranch(
          routes: <GoRoute>[
            GoRoute(path: "/commentReplies", builder: (context, state) => const CommentRepliesPage(), routes: [
              GoRoute(
                path: '/unfocused',
        ...
        StatefulShellBranch(
          routes: <GoRoute>[
            GoRoute(path: "/reposts", builder: (context, state) => const RepostsPage()),
          ],
        ),
        StatefulShellBranch(
          routes: <GoRoute>[
            GoRoute(path: "/reactions", builder: (context, state) => const ReactionsPage()),
          ],
        ),
      ],
    ),
