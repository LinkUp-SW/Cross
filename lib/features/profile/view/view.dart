...
class _ProfilePageState extends ConsumerState<ProfilePage> {
  ...
  String _formatDateRange(DateTime? startDate, DateTime? endDate,
      {bool isCurrent = false, bool doesNotExist = false}) {
  ...
  Future<void> _launchUrl(BuildContext context, String? urlString) async {
    if (urlString == null || urlString.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('No URL provided.'), backgroundColor: Colors.orange));
      return;
    }
  ...
  Widget _buildSkillItem(
      ...
      List<PositionModel>? experiences,
        ...
        switch (type) {
          ...
          case 'license':
            ...
            if (foundLic != null) {
              ...
              return {
                'name': foundLic.issuingOrganizationName,
                'logo': foundLic.issuingOrganizationLogoUrl
              };
            } else {
    ...
    if (skill.licenses != null && skill.licenses!.isNotEmpty) {
      ...
      linkedItemsWidgets.addAll(skill.licenses!.map((id) {
        ...
        return buildLinkedItemRow(
            name: details['name'] ?? 'Error',
            logoUrl: details['logo'],
            fallbackIcon: Icons.card_membership_outlined);
      }));
    }

    final linkedExperiences = experiences
        ?.where((exp) => exp.skills?.contains(skill.name) ?? false)
        .toList();
  ...
  Widget _buildEducationItem(EducationModel edu, bool isDarkMode) {
    ...
    final DateTime? endDate =
        edu.endDate != null ? DateTime.tryParse(edu.endDate!) : null;
    final bool isCurrentlyStudying =
        edu.endDate == null || edu.endDate!.isEmpty;
        ...
        children: [
          Container(
            ...
            child: logoUrl != null && logoUrl.isNotEmpty
                ? CachedNetworkImage(
                    imageUrl: logoUrl,
                    placeholder: (context, url) => Icon(Icons.school_outlined,
                        color: secondaryTextColor, size: 20.sp),
              ...
              children: [
                ...
                if (edu.degree.isNotEmpty || edu.fieldOfStudy.isNotEmpty)
                  Text(
                    ...
                    style:
                        TextStyles.font14_400Weight.copyWith(color: textColor),
                  ),
                SizedBox(height: 2.h),
                Text(
                  _formatDateRange(startDate, endDate,
                      isCurrent: isCurrentlyStudying, doesNotExist: false),
                  style: TextStyles.font12_400Weight
                      .copyWith(color: secondaryTextColor),
                ),
                SizedBox(height: 4.h),
                ...
                if (edu.activitesAndSocials != null &&
                    edu.activitesAndSocials!.isNotEmpty)
                  Padding(
                    padding: EdgeInsets.only(
                        top: edu.grade != null && edu.grade!.isNotEmpty
                            ? 4.h
                            : 0),
                    child: Text(
  ...
  Widget _buildExperienceItem(PositionModel exp, bool isDarkMode) {
    ...
    final DateTime? endDate = !exp.isCurrent && exp.endDate != null
        ? DateTime.tryParse(exp.endDate!)
        : null;
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  _formatDateRange(startDate, endDate,
                      isCurrent: exp.isCurrent, doesNotExist: false),
                  style: TextStyles.font12_400Weight
                      .copyWith(color: secondaryTextColor),
                ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 2.h),
                Text(
                  _formatDateRange(issueDate, expirationDate,
                      isCurrent: false, doesNotExist: lic.doesNotExpire),
                  style: TextStyles.font12_400Weight
                      .copyWith(color: secondaryTextColor),
                ),
                ...
                children: [
                  ...
                  if (hasResume)
                    SectionWidget(
                      title: "Resume",
                      onEditPressed: () =>
                          GoRouter.of(context).push('/add_resume'),
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: TextButton.icon(
                                    ...
                                    label: Text('Open Fullscreen',
                                        style: TextStyles.font14_600Weight
                  ...
                  if (showAboutSection)
                    SectionWidget(
                        title: "About",
                        onEditPressed: () =>
                            GoRouter.of(context).push('/edit_about'),
                            ...
                            : Column(
                                ...
                                children: [
                                  if (hasAboutText)
                                    Padding(
                                      padding: EdgeInsets.only(
                                          bottom: hasAboutSkills ? 0 : 8.h),
                                      child: Text(aboutData.about,
                                          style: TextStyles.font14_400Weight
                                              .copyWith(
                                                  color: sectionTextColor)),
                                    ),
                                  if (hasAboutSkills)
                                    _buildSkillsRowWidget(
                                        aboutData.skills, isDarkMode),
                                ],
                              )),
                  ...
                  SectionWidget(
                    ...
                    onEditPressed: allExperiences != null &&
                  ...
                  SectionWidget(
                    ...
                    onEditPressed: allEducations != null &&
                    ...
                    child: allEducations == null
                        ...
                        : (allEducations.isEmpty)
                            ? EmptySectionPlaceholder(
                                ...
                                datePlaceholder: "YYYY - Present",
                                sectionSubtitle:
                                    "Add your education details to show case your academic background",
                  ...
                  SectionWidget(
                    ...
                    onEditPressed: allLicenses != null && allLicenses.isNotEmpty
                        ? () => GoRouter.of(context).push(
                            '/edit_licenses_list') // TODO: Implement Licenses list editing page
                        : null,
                    child: allLicenses == null
                        ...
                        : allLicenses.isEmpty
                            ? EmptySectionPlaceholder(
                                ...
                                datePlaceholder: "YYYY-Present",
                                sectionSubtitle:
                                    "Add your licenses details to show case your academic background",
                                ...
                                children: [
                                  Column(
                                    children: displayedLicenses
                                        .map((lic) =>
                                            _buildLicenseItem(lic, isDarkMode))
                                        .toList(),
                                  ),
                                        ...
                                        child: Divider(
                                            ...
                                            color: isDarkMode
                                                ...
                                                : AppColors.lightGrey.withOpacity(
                                                    0.3)) // Adjusted divider color for consistency
                                        ),
                                    SizedBox(
                                      width: double.infinity,
                                      child: TextButton(
                                        onPressed: () {
                                          /* TODO: Implement Show All Licenses */
                                        },
                                        style: TextButton.styleFrom(
                                            padding: EdgeInsets.symmetric(
                                                vertical: 8.h),
                                ...
                                children: [
                                  ...
                                  if (showShowAllSkillsButton) ...[
                                    ...
                                    SizedBox(
                                      ...
                                      child: TextButton(
                                        onPressed: () {
                                          /* TODO: Implement Show All Skills */
                                        },
                                        style: TextButton.styleFrom(
                                            padding: EdgeInsets.symmetric(
                                                vertical: 8.h),
