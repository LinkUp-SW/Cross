  ...
  Future<void> refreshStatus() async {
     ...
     try {
       ...
       if (mounted) {
          ...
          log("[AddSectionViewModel] Updated state: isLoading=${state.isLoading}, hasAboutInfo=${state.hasAboutInfo}, hasResume=${state.hasResume}, hasLicenses=${state.hasLicenses}");
       }
     } catch (e) {
