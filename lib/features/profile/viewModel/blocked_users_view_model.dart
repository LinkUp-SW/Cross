...
class BlockedUsersViewModel extends StateNotifier<BlockedUsersState> {
  ...
  BlockedUsersViewModel(this._profileService, this._ref)
  ...
  Future<void> fetchBlockedUsers() async {
    if (state is BlockedUsersLoading ||
        state is BlockedUsersUnblocking ||
        state is BlockedUsersBlocking) return;
    ...
    try {
      ...
      if (mounted) {
        state =
            BlockedUsersError('Failed to load blocked users: ${e.toString()}');
      }
    }
  }
  ...
  Future<bool> unblockUser(String userId, String password) async {
    ...
    if (state is BlockedUsersUnblocking &&
        (state as BlockedUsersUnblocking).unblockingUserId == userId) {
  ...
  Future<bool> blockUser(String userId) async {
    ...
    try {
      ...
      if (success && mounted) {
        ...
        unawaited(
            _ref.read(profileViewModelProvider.notifier).fetchUserProfile());
