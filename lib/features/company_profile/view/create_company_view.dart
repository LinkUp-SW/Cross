...
class CreateCompanyProfilePage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CreateCompanyProfilePage> createState() =>
      _CreateCompanyProfilePageState();
}

class _CreateCompanyProfilePageState
    extends ConsumerState<CreateCompanyProfilePage> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      ref
          .read(companyProfileViewModelProvider.notifier)
                      ...
                      children: [
                        ...
                        if (state.isError) ...[
                          ...
                          Container(
                            ...
                            child: Text(
                              state.errorMessage ??
                                  'An error occurred while creating the company profile',
                              style: TextStyle(
                                color: Colors.red,
                                fontSize: 14.sp,
                              ),
