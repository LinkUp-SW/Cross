...
class CompanyProfileService {
  ...
  Future<Map<String, dynamic>> createCompanyProfile({
    ...
    try {
      ...
      developer.log('Response URL: ${ExternalEndPoints.baseUrl}${ExternalEndPoints.createCompanyProfile}');
  ...
  Future<Map<String, dynamic>> getCompanyProfile({
    ...
    try {
      ...
      developer.log('Got response with status: ${response.statusCode}');
      developer.log('Response URL: ${ExternalEndPoints.baseUrl}${ExternalEndPoints.getCompanyProfile.replaceAll(':companyId', companyId)}');
